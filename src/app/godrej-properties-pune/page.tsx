...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Godrej Properties Pune Price List 2026",
    ...
    "Godrej Rivergreens Mahalunge",
    "Godrej Hillside Mahalunge",
    "Godrej Meadows Mahalunge",
    "Godrej Green Vistas Mahalunge",
    "Godrej Boulevard Mahalunge",
    "Godrej Emerald Waters Pimpri",
    "Godrej Urban Retreat Kharadi",
    "Godrej Sky Vistas Kharadi",
    "Godrej Infinity Keshavnagar",
    "Godrej Rejuve Keshavnagar",
    "Godrej Greens Undri",
    "Godrej Horizon Undri",
    "Godrej Prana Undri",
    "Godrej Forest Grove Mamurdi",
    "Godrej Central Park Mamurdi",
    "Godrej Nurture Mamurdi",
    ...
    "Pune Real Estate Godrej Properties",
    "Godrej Properties Pune Reviews",
    "Godrej Properties Pune Sales Office",
    "Godrej Properties Pune Contact Number",
    "Godrej Properties Pune Ready to Move Flats",
    "Godrej Properties Pune Pre Launch Offers",
    "Godrej Flats in Hinjewadi",
    "Godrej Flats in Mahalunge",
    "Godrej Flats in Kharadi",
    "Godrej Flats in PCMC",
    "Godrej Flats in Undri",
    "Top Real Estate Developers in Pune",
    "Best Township Projects in Pune",
    "Godrej Properties MahaRERA Approved Projects",
    "Godrej Properties Pune NRI Investment",
    "Buy Flat in Pune Godrej Properties"
  ],
  alternates: {
