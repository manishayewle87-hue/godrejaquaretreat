      ...
      <div className="relative z-30 h-full flex flex-col justify-center items-start pt-20 px-6 lg:px-16 max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-700 text-lg md:text-2xl font-light max-w-3xl mb-12 leading-relaxed">
            Where water shapes life, every space flows with calm, grace & meaning. Experience resort-style luxury living and buy a premium 2 & 3 BHK flat at Godrej The Retreat (The Aqua Retreat) at Godrej Park World Hinjewadi Phase 1, Pune.
          </p>
